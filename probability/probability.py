...
def main():
    ...
    st.markdown(
        "<p style='font-size: 24px;'>The probability of either event A or event B occurring:</p>",
    ...
    """)
    st.markdown(
        "<h3 style='font-size: 24px;'>Important concepts:</h3>", unsafe_allow_html=True
    )
    ...
    st.markdown(
        "<p style='font-size: 24px;'>The probability of event A occurring, given that event B has occurred:</p>",
        unsafe_allow_html=True,
    )
    st.latex(r"""
    ...
    """)
    st.markdown(
        "<p style='font-size: 24px;'>Independence in terms of conditional probability:</p>",
        unsafe_allow_html=True,
    )
    st.latex(r"""
    ...
    st.markdown(
        "<p style='font-size: 24px;'>The probability of an event not occurring:</p>",
        unsafe_allow_html=True,
    )
    st.latex(r"""
    P(A^c) = 1 - P(A)
    ...
    st.markdown(
        "<p style='font-size: 24px;'>The probability of both events A and B occurring:</p>",
        unsafe_allow_html=True,
    )
    st.latex(r"""
    ...
    """)
    st.markdown(
        "<p style='font-size: 24px;'>Note: This rule applies to both dependent and independent events.</p>",
        unsafe_allow_html=True,
    )
