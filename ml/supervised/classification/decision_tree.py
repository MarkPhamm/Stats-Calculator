...
def main():
    ...
    with tab1:
        ...
        with col_viz:
            ...
            plot_tree(tree_clf, filled=True, feature_names=["X1", "X2"], class_names=["Class 0", "Class 1"], ax=ax_tree)
            st.pyplot(fig_tree)
    ...
    with tab2:
        ...
        uploaded_file = st.file_uploader("Upload CSV/Excel", type=["csv", "xlsx"], key="dt_upload")
        ...
        if uploaded_file is not None:
            ...
            if feature_cols and st.button("Train Decision Tree"):
                ...
                sns.barplot(data=imp_df, x='Importance', y='Feature', ax=ax_imp, palette='viridis')
                st.pyplot(fig_imp)
